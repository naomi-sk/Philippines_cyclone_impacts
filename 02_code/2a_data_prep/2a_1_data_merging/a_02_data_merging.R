...
## Load datasets
storm_winds_ADM2 <- read_csv("03_output/3c_intermediate_cleaned/storm_winds_ADM2.csv")
...
merged_exposure_outcome_data <- pp_mortality_ADM2 %>%
...
sex_stratified <- merged_exposure_outcome_data %>%
...
write_csv(merged_exposure_outcome_data, "03_output/3d_final_merged/cyclone_mortality_merged_data.csv")

# Save the sex-stratified dataset
write_csv(sex_stratified, "03_output/3d_final_merged/cyclone_mortality_sex_stratified.csv")
